...
optimizer_ft = torch.optim.Adam(model.parameters(), lr= lr, weight_decay=L2_lambda)
...
# ### Train and evaluate
# %%
writer_name = f"{model_name}_L2_{optimizer_name}_lr_{lr}_gamma_{gamma}_batch_size_{batch_size}"
