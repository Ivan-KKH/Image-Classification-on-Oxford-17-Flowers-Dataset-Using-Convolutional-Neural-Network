...
for class_images in train_images:
    for img in class_images: 
        ...
        # os.system(f"cp raw/{img} flower/train/{class_i}")  # for mac
        os.system(f"copy raw\\{img} flower\\train\\{class_i}")  # for windows
...
for class_images in val_images:
    for img in class_images:                                 
        ...
        # os.system(f"cp raw/{img} flower/val/{class_i}")  # for mac
        os.system(f"copy raw\\{img} flower\\val\\{class_i}")  # for windows
    print("val", class_i)
    cnt += 1
...
for class_images in test_images:
    for img in class_images:                                 
        ...
        # os.system(f"cp raw/{img} flower/test/{class_i}")  # for mac
        os.system(f"copy raw\\{img} flower\\test\\{class_i}")  # for windows
    print("test", class_i)
    cnt += 1
