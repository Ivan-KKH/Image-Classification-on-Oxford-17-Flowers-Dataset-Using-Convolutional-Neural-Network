...
def ResNet18(img_channels=3, num_classes=17):
    return ResNet(18, Block, img_channels, num_classes)


def ResNet34(img_channels=3, num_classes=17):
...
def ResNet101(img_channels=3, num_classes=17):
    return ResNet(101, Block, img_channels, num_classes)


def ResNet152(img_channels=3, num_classes=17):
